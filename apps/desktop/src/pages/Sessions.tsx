      ...
      <PageActionsSlot>
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`bg-primary text-white rounded-full px-3 sm:px-4 py-2 text-[14px] font-medium hover:bg-primary/90 active:scale-95 transition-all flex items-center gap-1.5${launched ? ' opacity-90' : ''}`}
