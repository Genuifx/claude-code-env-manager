...
export function buildWorkspaceCronAgentPrompt(
  ...
  return {
    ...
    prompt: [
      ...
      '- 传给 CLI 的 JSON 字段使用：name、cronExpression、prompt、workingDir、envName、executionProfile、maxBudgetUsd、allowedTools、disallowedTools、enabled、timeoutSecs、templateId。',
