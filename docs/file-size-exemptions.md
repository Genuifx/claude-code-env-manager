...
- `apps/desktop/src-tauri/src/skills.rs`: Skill discovery, install, uninstall, and curated metadata handling remain bundled in the current Tauri command module.
